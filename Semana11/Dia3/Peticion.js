window.onload=function(){
    ...
    function eliminarProducto(id)
    {
        ...
        xhr.open("DELETE","https://5d4b6ab600dbb10014879b09.mockapi.io/productos/"+id);
        xhr.send(null);
    ...
    function imprimirDetalle(id){
        ...
        xhr.open("GET","https://5d4b6ab600dbb10014879b09.mockapi.io/productos/"+id);
    ...
    function obtenerProductos(){
        ...
        xhr.open("GET","https://5d4b6ab600dbb10014879b09.mockapi.io/productos");
